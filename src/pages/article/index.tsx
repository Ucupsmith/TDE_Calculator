...
const articles = [
  {
    ...
    imageSrc: '/tdee1.png',
    authorName: 'Darrell Wijaya',
    authorImage: '/joko.jpg'
  },
  {
    id: 2,
  ...
  },
  {
    ...
    imageSrc: '/tdee3.jpg',
    authorName: 'Arya Riyanto',
    authorImage: '/nilon.jpg'
  },
  {
    id: 4,
  ...
  {
    id: 8,
    title: 'Menjaga Berat Badan Ideal dengan Memahami TDEE',
    imageSrc: '/tdee8.jpg',
    authorName: 'Arya Riyanto',
    authorImage: '/nilon.jpg'
  },
  ...
  {
    id: 14,
    title: 'Memahami TDEE untuk Ibu Hamil',
    imageSrc: '/tdee2.jpg',
    authorName: 'Arya Riyanto',
    authorImage: '/nilon.jpg'
  },
  {
    id: 15,
    title: 'Menyesuaikan TDEE untuk Kenaikan Berat Badan',
    imageSrc: '/tdee3.jpg',
    authorName: 'Arya Riyanto',
    authorImage: '/nilon.jpg'
  },
  {
    id: 16,
    title: 'TDEE pada Lansia: Apa yang Berubah?',
    imageSrc: '/tdee4.jpg',
    authorName: 'Arya Riyanto',
    authorImage: '/nilon.jpg'
  },
  {
    id: 17,
    title: 'Dampak Olahraga Intensitas Tinggi pada TDEE',
    imageSrc: '/tdee5.jpeg',
    authorName: 'Arya Riyanto',
    authorImage: '/nilon.jpg'
  },
  {
    id: 18,
    title: 'Hubungan Antara TDEE dan Kualitas Tidur',
    imageSrc: '/tdee6.jpg',
    authorName: 'Arya Riyanto',
    authorImage: '/nilon.jpg'
  },
  {
    id: 19,
    title: 'Bagaimana Stres Mempengaruhi Perhitungan TDEE',
    imageSrc: '/tdee7.jpg',
    authorName: 'Arya Riyanto',
    authorImage: '/nilon.jpg'
  },
  {
    id: 20,
    title: 'Menggunakan TDEE untuk Merancang Meal Plan',
    imageSrc: '/tdee8.jpg',
    authorName: 'Arya Riyanto',
    authorImage: '/nilon.jpg'
  },
  {
    id: 21,
    title: 'Perbedaan Detail antara TDEE, BMR, dan RMR',
    imageSrc: '/tdee9.webp',
    authorName: 'Arya Riyanto',
    authorImage: '/nilon.jpg'
  },
  {
    id: 22,
    title: 'Menghitung TDEE untuk Berbagai Bentuk Tubuh',
    imageSrc: '/tdee10.jpg',
    authorName: 'Arya Riyanto',
    authorImage: '/nilon.jpg'
  },
  {
    id: 23,
    title: 'TDEE dan Kaitannya dengan Kesehatan Hormonal',
    imageSrc: '/tdee11.jpg',
    authorName: 'Arya Riyanto',
    authorImage: '/nilon.jpg'
  },
  {
    id: 24,
    title: 'Mengapa TDEE Penting untuk Perjalanan Kesehatan Anda',
    imageSrc: '/tdee12.webp',
    authorName: 'Arya Riyanto',
    authorImage: '/nilon.jpg'
  },
  {
    id: 25,
    title: 'Memanfaatkan TDEE untuk Mencapai Tujuan Penurunan Berat',
    imageSrc: '/tdee1.png',
    authorName: 'Arya Riyanto',
    authorImage: '/nilon.jpg'
  },
  {
    id: 26,
    title: 'Kesalahan Umum dalam Perhitungan TDEE',
    imageSrc: '/tdee2.jpg',
    authorName: 'Arya Riyanto',
    authorImage: '/nilon.jpg'
  },
  {
    id: 27,
    title: 'Menyesuaikan TDEE Sesuai Perubahan Musim',
    imageSrc: '/tdee3.jpg',
    authorName: 'Arya Riyanto',
    authorImage: '/nilon.jpg'
  },
  {
    id: 28,
    title: 'Menggunakan TDEE untuk Program Weight Loss Efektif',
    imageSrc: '/tdee4.jpg',
    authorName: 'Arya Riyanto',
    authorImage: '/nilon.jpg'
  },
  {
    id: 29,
    title: 'TDEE dan Konsistensi: Kunci Sukses Jangka Panjang',
    imageSrc: '/tdee5.jpeg',
    authorName: 'Arya Riyanto',
    authorImage: '/nilon.jpg'
  },
  {
    id: 30,
    title: 'Mengintegrasikan TDEE dalam Gaya Hidup Sehat',
    imageSrc: '/tdee6.jpg',
    authorName: 'Arya Riyanto',
    authorImage: '/nilon.jpg'
  },
  {
    id: 31,
    title: 'TDEE untuk Performa Optimal dalam Olahraga Endurance',
    imageSrc: '/tdee7.jpg',
    authorName: 'Arya Riyanto',
    authorImage: '/nilon.jpg'
  },
  {
    id: 32,
    title: 'Bagaimana TDEE Mempengaruhi Tingkat Energi Anda',
    imageSrc: '/tdee8.jpg',
    authorName: 'Arya Riyanto',
    authorImage: '/nilon.jpg'
  },
  {
    id: 33,
    title: 'TDEE: Relevansinya dengan Gizi Harian',
    imageSrc: '/tdee9.webp',
    authorName: 'Arya Riyanto',
    authorImage: '/nilon.jpg'
  },
  {
    id: 34,
    title: 'Pengaruh TDEE pada Kebiasaan Makan',
    imageSrc: '/tdee10.jpg',
    authorName: 'Arya Riyanto',
    authorImage: '/nilon.jpg'
  },
  {
    id: 35,
    title: 'Hubungan Antara TDEE dan Makronutrien',
    imageSrc: '/tdee11.jpg',
    authorName: 'Arya Riyanto',
    authorImage: '/nilon.jpg'
  },
  {
    id: 36,
    title: 'Menghitung TDEE untuk Latihan Intensitas Tinggi',
    imageSrc: '/tdee12.webp',
    authorName: 'Arya Riyanto',
    authorImage: '/nilon.jpg'
  },
  {
    id: 37,
    title: 'Peran TDEE dalam Menjaga Kesehatan Optimal',
    imageSrc: '/tdee1.png',
    authorName: 'Arya Riyanto',
    authorImage: '/nilon.jpg'
  },
  {
    id: 38,
    title: 'TDEE dan Perannya dalam Kesehatan Metabolik',
    imageSrc: '/tdee2.jpg',
    authorName: 'Arya Riyanto',
    authorImage: '/nilon.jpg'
  },
  {
    id: 39,
    title: 'Mengapa TDEE Anda Mungkin Lebih Tinggi dari Perkiraan',
    imageSrc: '/tdee3.jpg',
    authorName: 'Arya Riyanto',
    authorImage: '/nilon.jpg'
  },
  {
    id: 40,
    title: 'Cara Mengintegrasikan TDEE dalam Gaya Hidup Anda',
    imageSrc: '/tdee4.jpg',
    authorName: 'Arya Riyanto',
    authorImage: '/nilon.jpg'
  },
  {
    id: 41,
    title: 'TDEE untuk Penurunan Berat Badan Cepat',
    imageSrc: '/tdee5.jpeg',
    authorName: 'Arya Riyanto',
    authorImage: '/nilon.jpg'
  },
  {
    id: 42,
    title: 'TDEE dan Pengaruhnya pada Mood',
    imageSrc: '/tdee6.jpg',
    authorName: 'Arya Riyanto',
    authorImage: '/nilon.jpg'
  },
  {
    id: 43,
    title: 'Menghitung TDEE untuk Anak-anak dan Remaja',
    imageSrc: '/tdee7.jpg',
    authorName: 'Arya Riyanto',
    authorImage: '/nilon.jpg'
  },
  {
    id: 44,
    title: 'Peran TDEE dalam Pemulihan Pasca-Latihan',
    imageSrc: '/tdee8.jpg',
    authorName: 'Arya Riyanto',
    authorImage: '/nilon.jpg'
  },
  ...
  {
    id: 46,
    title: 'Mengoptimalkan TDEE untuk Peningkatan Performa',
    imageSrc: '/tdee10.jpg',
    authorName: 'Arya Riyanto',
    authorImage: '/nilon.jpg'
  },
  {
    id: 47,
    title: 'Bagaimana TDEE Berubah Selama Siklus Menstruasi',
    imageSrc: '/tdee11.jpg',
    authorName: 'Arya Riyanto',
    authorImage: '/nilon.jpg'
  },
  {
    id: 48,
    title: 'TDEE dan Pentingnya Hidrasi',
    imageSrc: '/tdee12.webp',
    authorName: 'Arya Riyanto',
    authorImage: '/nilon.jpg'
  },
  {
    id: 49,
    title: 'Memahami TDEE Saat Puasa Intermiten',
    imageSrc: '/tdee1.png',
    authorName: 'Arya Riyanto',
    authorImage: '/nilon.jpg'
  },
  {
    id: 50,
    title: 'TDEE: Merencanakan Cheat Day Tanup Merusak Progress',
    imageSrc: '/tdee2.jpg',
    authorName: 'Arya Riyanto',
    authorImage: '/nilon.jpg'
  }
      ...
      <div className='flex justify-center mt-6 sm:mt-8 items-center space-x-4 relative'>
        ...
        <div
          className={`transition-all duration-500 ease-in-out ${
            showSearch
              ? 'opacity-100 scale-100 max-w-[280px] sm:max-w-[320px]'
