...
const Navbar = () => {
  ...
  return (
    <div className='w-full flex fixed bottom-0 left-0 right-0 z-10 py-0 md:py-3 px-0 items-end justify-center md:relative bg-opacity-50'>
      <div className='w-full h-[70px] flex flex-row items-start md:items-center md:px-2 border border-none px-0 md:bg-[#144B3C] bg-[#143238] md:rounded-[20px] rounded-t-xl'>
