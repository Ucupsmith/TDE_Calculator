...
import { FaInfoCircle, FaFire, FaDumbbell, FaWeight, FaHeartbeat, FaRocket } from 'react-icons/fa';
...
const TdeeCalculationComponent: React.FC<TdeeProps> = ({
  ...
  return (
    <div className='w-full pt-4 md:pt-6 scroll-mt-24'>
      {!loading ? (
        <div ref={resultsSectionRef} className='w-full transition-all duration-300 mt-4 scroll-mt-24'>
          {showRocket && (
            <motion.div
                  ...
                  <CardBody className='h-full flex flex-col items-center justify-center p-4'>
                    <div className='flex items-center gap-2 mb-2'>
                      {bmi < 18.5 ? (
                        ...
                        <FaDumbbell className={bmi <= 24.9 ? 'text-yellow-600' : bmi <= 29.9 ? 'text-yellow-700' : 'text-red-600'} />
                      )}
                      <Typography
                      ...
                      <div className='pt-3 border-t border-gray-600 mt-3'>
                        <div className='grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs md:text-sm'>
                          <div className='flex items-center gap-1'>
                            <div className='w-3 h-3 bg-yellow-300/30 rounded-sm'></div> Underweight: &lt;18.5
                          </div>
                          <div className='flex items-center gap-1'>
                            <div className='w-3 h-3 bg-green-400/30 rounded-sm'></div> Normal: 18.5-23.9
                          </div>
                          <div className='flex items-center gap-1'>
                            <div className='w-3 h-3 bg-yellow-600/30 rounded-sm'></div> Overweight: 24-27
                          </div>
                          <div className='flex items-center gap-1'>
                            <div className='w-3 h-3 bg-red-600/30 rounded-sm'></div> Obese: &gt;27
                          </div>
                        </div>
                      </div>
                    </motion.div>
