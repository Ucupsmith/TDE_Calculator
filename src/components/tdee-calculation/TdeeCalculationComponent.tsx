...
const TdeeCalculationComponent: React.FC<TdeeProps> = ({
  ...
  return (
    <div className='w-full pt-4 md:pt-6 scroll-mt-24'>
      {!loading &&
      typeof bmi !== undefined &&
      typeof tdee !== undefined &&
      typeof bmiCategory !== undefined &&
      typeof goal !== undefined ? (
        <div
          ref={resultsSectionRef}
          className='w-full flex flex-col transition-all duration-300 mt-4 scroll-mt-24'
        >
          {showRocket && (
            <motion.div
              className='fixed z-50 pointer-events-none border'
              style={{
          ...
          >
            ...
            <div className='md:flex md:flex-row gap-2 justify-center items-start'>
              <div className='flex flex-col md:flex-row w-full px-3 gap-6 md:gap-8 items-center justify-center md:py-0'>
                {/* TDEE Card */}
                <motion.div
                      ...
                      <AnimatePresence>
                        {showTdeeTooltip && (
                          <motion.div
                            ...
                            animate={{ opacity: 1, y: 0 }}
                            exit={{ opacity: 0, y: 10 }}
                            className='absolute z-50 w-64 p-3 text-sm bg-gray-800 text-gray-100 rounded-lg shadow-lg -left-44 top-6 right-0 md:-left-52'
                          >
              ...
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.5 }}
                className='flex flex-col w-full md:h-auto h-auto gap-6 py-4 md:py-0'
              >
                <div className='flex flex-col md:flex-row w-full px-3 gap-6 md:gap-8 justify-center'>
                  {/* BMI Card */}
                  <motion.div
                    initial={{ x: 20, opacity: 0 }}
                    animate={{ x: 0, opacity: 1 }}
        ...
        <div className='h-screen flex flex-col items-center justify-center'>
          <div className='flex flex-col gap-2 items-center justify-center'>
            ...
            <Typography className='text-white font-poppins font-semibold text-xl md:text-2xl transition-all duration-150 animate-fade-in-slide'>
              {' '}
              loading ...
            </Typography>
          </div>
