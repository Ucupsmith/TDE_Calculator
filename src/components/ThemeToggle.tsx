...
const ThemeToggle: React.FC = () => {
  ...
  return (
    <div className="w-full flex justify-end items-center pt-4 pb-2 pr-4 z-30">
      <button
        aria-label="Toggle Dark Mode"
        onClick={toggleTheme}
        className="p-2 rounded-full border border-gray-300 bg-white dark:bg-gray-800
      ...
      >
        <span
          className={`inline-block transition-transform duration-500 ${
            theme === 'dark' ? 'rotate-[360deg] scale-110' : 'rotate-0 scale-100'
          }`}
        >
          {theme === 'dark' ? (
            /* Ikon bulan */
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
              <path fill="#FBBF24" d="M21 12.79A9 9 0 1111.21 3a7 7 0 109.79 9.79z" />
            </svg>
          ) : (
            /* Ikon matahari */
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
